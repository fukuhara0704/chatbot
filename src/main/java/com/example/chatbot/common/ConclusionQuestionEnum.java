...
public enum ConclusionQuestionEnum {
    ...
    private ConclusionQuestionEnum(String label, int id) {
        this.label = label;
        this.id = id;
    }
    ...
    public static String getVauleById(int id) {
        ...
        for( ConclusionQuestionEnum e : ConclusionQuestionEnum.values() ) { //拡張for文による走査
            if( e.getId() == id ) {
